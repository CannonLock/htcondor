...
warn_on_gsi_usage()
{
	...
	if ( subsys_type == SUBSYSTEM_TYPE_TOOL || subsys_type == SUBSYSTEM_TYPE_SUBMIT ) {
		...
		fprintf(stderr, "For details, see https://htcondor.org/wiki-archive/pages/PlanToReplaceGridCommunityToolkit/\n");
	} else {
		...
		dprintf(D_ALWAYS, "For details, see https://htcondor.org/wiki-archive/pages/PlanToReplaceGridCommunityToolkit/\n");
	}
}
